...
console.log("Neue-Spiele-Prompt nennt Brettspiel-Community ueber alle Kanaele (nicht nur BGG):", t.includes("Brettspiel-Community") && t.includes("Reddit") && t.includes("YouTube"));
